...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__reverse_pipe__ = __webpack_require__("../../../../../src/app/reverse.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["H" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__reverse_pipe__["a" /* ReversePipe */]
            ],
            imports: [
...
module.exports = "<div class=\"container\">\n  <mat-card>\n    <form class=\"example-form\">\n      <mat-form-field class=\"example-full-width\">\n        <input #task matInput placeholder=\"Добавьте задачу\" >\n      </mat-form-field>\n      <button type=\"submit\" mat-button color=\"primary\" (click)=\"create(task)\">Добавить</button>\n    </form>\n\n  </mat-card>\n  <mat-card *ngIf=\"todos.length\">\n    <mat-list>\n      <mat-list-item *ngFor=\"let todo of (todos|reverse)\">\n        <mat-checkbox color=\"primary\" [(ngModel)]=\"todo.completed\" [ngClass]=\"{ 'completed': todo.completed }\">\n          {{todo.name}}\n        </mat-checkbox>\n\n        <button mat-icon-button (click)=\"delete(todo)\">\n          <mat-icon>delete</mat-icon>\n        </button>\n      </mat-list-item>\n    </mat-list>\n  </mat-card>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__todo__ = __webpack_require__("../../../../../src/app/content/todo.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ContentComponent = (function () {
    function ContentComponent() {
        this.todos = JSON.parse(document.cookie);
    }
    ContentComponent.prototype.delete = function (todo) {
        var id = this.todos.indexOf(todo);
        if (id > -1) {
            this.todos.splice(id, 1);
            document.cookie = JSON.stringify(this.todos);
        }
    };
    ContentComponent.prototype.create = function (task) {
        if (task.value && !(/^[\s]+$/.test(task.value))) {
            this.todos.push(new __WEBPACK_IMPORTED_MODULE_1__todo__["a" /* Todo */](task.value, false));
        }
        document.cookie = JSON.stringify(this.todos);
        task.value = '';
...
module.exports = "<mat-toolbar color=\"primary\">Todo </mat-toolbar>\n"
...
var ReversePipe = (function () {
    ...
    ReversePipe.prototype.transform = function (tickets) {
